...
HD_PWD='C:/Users/labview/project_99/project_99.runs/design_1_slv_intr_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_slv_intr_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_slv_intr_0_0.tcl
