...
HD_PWD='C:/Users/labview/axis_slvMas/axis_slvMas.runs/design_1_axis_SM_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axis_SM_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axis_SM_0_0.tcl
